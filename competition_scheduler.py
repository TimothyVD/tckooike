...
function buildNav() {
  ...
  html += '<a href="https://www.padelkooike.be/" target="_blank" class="nav-padel-link" title="Padel Kooike">' +
    '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#4caf50"/><path d="M3.5 8.5 C7 5, 12 7, 12 12 C12 17, 17 19, 20.5 15.5" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M3.5 15.5 C7 19, 12 17, 12 12 C12 7, 17 5, 20.5 8.5" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/></svg>' +
    ' Padel Kooike</a>';
  nav.innerHTML = html;
