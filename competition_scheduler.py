...
function buildNav() {
  ...
  html += '<a href="https://www.padelkooike.be/" target="_blank" class="nav-padel-link" title="Padel Kooike">' +
    '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10"/><path d="M6 12q6-7 12 0" stroke="white" stroke-width="1.5" fill="none"/><path d="M6 12q6 7 12 0" stroke="white" stroke-width="1.5" fill="none"/></svg>' +
    ' Padel Kooike</a>';
  nav.innerHTML = html;
