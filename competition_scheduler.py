...
<header class="site-header">
  ...
  <div class="hdr-actions">
    ...
    <a href="https://www.padelkooike.be/" target="_blank" class="btn btn-ghost" title="Padel Kooike" style="gap:7px">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="12" rx="10" ry="10"/><path d="M8 12h8M12 8v8"/><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none" opacity=".3"/></svg>
      <span class="btn-label">Padel Kooike</span>
    </a>
  </div>
...
function panelSchool() {
  return '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:16px">' +
    '<img src="images/school/whackit.png" alt="WhackIt" style="width:100%;height:180px;object-fit:contain;background:#f9f9f9;border-radius:10px" onerror="this.style.display=\'none\'">' +
